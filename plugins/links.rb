class Links
  ...
  def forums(m)
    m.reply 'You can chat on the forums here: https://forums.cloudcitymc.us'
  end

  def rules(m)
    m.reply 'You can read the rules here: https://cloudcitymc.us/rules'
  end

  def vote(m)
    m.reply 'You can find the vote links here: https://cloudcitymc.us/vote'
  end

  def irc(m)
    m.reply 'You can chat with us on IRC here: https://cloudcitymc.us/irc'
  end

  def report(m)
    m.reply 'You can report players on the forums here: https://cloudcitymc.us/report'
  end

  def sell(m)
    m.reply 'Want to report a missing item from /sell? Do it on the forums here: https://cloudcitymc.us/sell'
  end

  def shop(m)
    m.reply 'Want to suggest an item to be added to the shop? Do it on the forums here: https://cloudcitymc.us/shop'
  end
